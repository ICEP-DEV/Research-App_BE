...
(1, 'According to TUT policy on Postgraduate Studies, your research proposal should be completed within 6 months of registration for your M Ed or D Ed. In the Department of Educational Studies, you have to present your proposal at a Research Proposal Seminar in June.  After you have made the final changes, your proposal must be approved by the Departmental Research & Innovation Committee (DRIC) as well as by the University Higher Degrees Committee The approval process will be undertaken by your supervisor. ', 3, '2022-03-14 13:12:38', '2022-03-14 13:12:38'),
(2, 'Your proposal should, with the support and advice of your supervisor, be developed according to the guidelines herein stated.  These guidelines apply, more-or-less, to both Masters and Doctoral research proposals, and should be between 10-15 pages in length, excluding references and appendices.', 3, '2022-03-14 13:13:00', '2022-03-14 13:13:00'),
(3, 'What is essential in preparing your proposal is that your supervisor and DRIC must have sufficient evidence that you: \r\n\r\n•	have a clear-enough idea what research you hope to undertake in terms of the area and topic, \r\n•	will be able to find enough literature sources to explain the theoretical background of your study, \r\n•	know which research design will be most suitable for your research, \r\n•	will be able to complete the study in the prescribed time (M Ed two years, D Ed three years) and, \r\n•	have the academic background and competences to bring the project to a successful completion.\r\n', 3, '2022-03-14 13:13:42', '2022-03-14 13:13:42'),
(4, 'The template presented is guide to assist students in completing their proposal. You need not follow the sections (and their titles) below word-for-word; however, your proposal should present the gist required by the sections below.', 3, '2022-03-14 13:14:56', '2022-03-14 13:14:56'),
(5, 'Opening (Quotation or general statement)', 5, '2022-03-14 13:18:48', '2022-03-14 13:18:48'),
(6, 'Establishing common ground (Contextualise problem, Significance and relevance, current status of the problem, Discussion of previous studies, limitations, omissions \r\nPrevious literature summarised, reviewed', 5, '2022-03-14 13:20:20', '2022-03-14 13:20:20'),
(7, 'Prepare for current research (Denial (on the other hand), indicate gap in previous research, indicate how this research will fill the gap, state the cost of leaving the condition unsolved', 5, '2022-03-14 13:21:06', '2022-03-14 13:21:06'),
(8, 'Resolution (purpose of the research, focus, outline or overview, maybe a short indication of research methods, overview of what will follow)', 5, '2022-03-14 13:21:42', '2022-03-14 13:21:42'),
...
(16, 'Formulate your main research question.  This should contain elements of the research topic and what was mentioned in the problem statement (REMEMBER THE GOLDEN THREAD)', 9, '2022-03-14 13:42:48', '2022-03-14 13:42:48'),
(17, 'Formulate four sub-questions which will contribute to answering the main research question', 9, '2022-03-14 13:43:15', '2022-03-14 13:43:15'),
...
INSERT INTO `users` (`id`, `firstName`, `lastName`, `email`, `password`, `idNumber`, `title`, `photo`, `userType`, `references`, `departmentId`, `verified`, `createdAt`, `updatedAt`) VALUES
(1, 'Shiko', 'Matlala', 'shikomatlala@gmail.com', 'shiko', '9511275418082', 'Mr', 'Get the API', '1', NULL, NULL, 0, '2022-03-17 09:34:15', '2022-03-17 09:34:15'),
